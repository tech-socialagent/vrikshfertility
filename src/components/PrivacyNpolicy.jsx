...
const PrivacyNpolicy=()=>{
    ...
    return(
        <div className='terms'>
        <h1>Privacy Policy for Vriksh Fertility</h1>
        <p>
          At www.vrikshfertility.com, accessible from
          https://www.vrikshfertility.com/, one of our main priorities is the
          privacy of our visitors. This Privacy Policy document contains types of
          information that is collected and recorded by www.vrikshfertility.com
          and how we use it.
        </p>
        <p>
        ...
        <p>
          ...
          shared and/or collect in www.vrikshfertility.com. This policy is not
        ...
        <h2>Log Files</h2>
        <p>
          www.vrikshfertility.com follows a standard procedure of using log files.
        ...
        <p>
          Like any other website, www.vrikshfertility.com uses
        ...
        <p>
          ...
          advertising partners of www.vrikshfertility.com.
        </p>
        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on www.vrikshfertility.com, which
        ...
        <p>
          Note that www.vrikshfertility.com has no access to or control over these
          cookies that are used by third-party advertisers.
        </p>
        <h2>Third Party Privacy Policies</h2>
        <p>
          www.vrikshfertility.com&apos;s Privacy Policy does not apply to other
        ...
        <p>
          www.vrikshfertility.com does not knowingly collect any Personal
