...
const TermsNconditions = () => {
  ...
  return (
    <div className="terms">
      ...
      <p>Welcome to vrikshfertility.com!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of Vriksh Fertility&apos;s Website, located at
        https://www.vrikshfertility.com/.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use vrikshfertility.com if you do not
      ...
      <p>
        We employ the use of cookies. By accessing vrikshfertility.com, you
        agreed to use cookies in agreement with the Vriksh Fertility&apos;s
        Privacy Policy.
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, Vriksh Fertility and/or its licensors own the
        intellectual property rights for all material on vrikshfertility.com.
        All intellectual property rights are reserved. You may access this from
        vrikshfertility.com for your own personal use subjected to restrictions
        set in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from vrikshfertility.com</li>
        <li>Sell, rent or sub-license material from vrikshfertility.com</li>
        <li>Reproduce, duplicate or copy material from vrikshfertility.com</li>
        <li>Redistribute content from vrikshfertility.com</li>
      </ul>
      <p>
      ...
      <p>
        ...
        Vriksh Fertility does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of Vriksh Fertility,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Vriksh Fertility
      ...
      <p>
        Vriksh Fertility reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant Vriksh Fertility a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Vriksh Fertility; and (d) the
      ...
      <p>
        ...
        e-mail to Vriksh Fertility. Please include your name, your organization
      ...
      <p>
        No use of Vriksh Fertility&apos;s logo or other artwork will be allowed
